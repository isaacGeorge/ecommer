    ...
    return (
        <div class='flex flex-col items-center space-y-4 p-20 text-gray-600'>
            ...
            <div class='bg-slate-200  p-5 rounded-2xl flex flex-col space-y-4'>
                ...
                <p class='text-sm'>Class porta minim in, quam, rutrum fermentum et pharetra praesent! Culpa blandit, vero sem iusto fringilla lorem, tempor aenean? Tortor. fugiat voluptatibus, dolorum</p>
                <butto class='border-2 border-black px-4 py-1 text-black font-bold inline-block rounded-full w-fit cursor-pointer'>Help</butto>
            </div>
            </div>
        </div>
    )
